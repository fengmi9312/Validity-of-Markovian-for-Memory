...
if __name__ == '__main__':
    ...
    for pair_item in group_param_list[rank]:
        ...
        if add_mark:
            writer_add = pd.ExcelWriter("../Experimental_Data/lognormal_fitting_data/data_curves_"+ file_mark + ".xlsx")
        writer = pd.ExcelWriter("../Experimental_Data/lognormal_fitting_data/data_"+ file_mark + ".xlsx")
