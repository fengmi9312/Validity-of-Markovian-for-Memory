...
if __name__ == '__main__':
    ...
    writer = pd.ExcelWriter("../ExperimentalData/transient_equivalence_data/"+ func_type + "_" + str(mean_inf) + "_" + str(mean_rem) + "_" + str(steady_level) + ".xlsx")
