...
if __name__ == '__main__':
    ...
    for pair_item in group_param_list[rank]:
        ...
        beta_rem = get_beta_from_weibull(alpha_rem, mean_rem)
        if add_mark:
            writer_add = pd.ExcelWriter("../ExperimentalData/forecasting_data_i5r7_level8/data_curves_"+ file_mark + ".xlsx")
        writer = pd.ExcelWriter("../ExperimentalData/forecasting_data_i5r7_level8/data_"+ file_mark + ".xlsx")
