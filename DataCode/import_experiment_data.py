...
def import_transient_data():
    ...
    for func_type, mean_inf, mean_rem, steady_level in trans_list:
        ...
        pd.read_excel("../Experimental_Data/transient_calc/trans_equivalence_data/"+ 
...
def import_r0_g_data():
    ...
    for func_type, mean_inf, mean_rem, steady_level in trans_list:
        ...
        r0_g_data[func_ir_name] = pd.read_excel("../Experimental_Data/r0_g_data/r0_g_calc_"+ file_name + ".xlsx", index_col = 0, sheet_name = None)
    return r0_g_data
        
def import_simu_data():
    _data = pd.read_excel('../Experimental_Data/non_m_theory_ijk/theory_data/simu_data.xlsx', index_col = 0, sheet_name = None)
    print('simu data imported')
    return _data
    
def import_calc_data():
    _data = pd.read_excel('../Experimental_Data/non_m_theory_ijk/theory_data/calc_data.xlsx', index_col = 0, sheet_name = None)
    print('calc data imported')
    return _data
    
def import_simu_data_m():
    _data = pd.read_excel('../Experimental_Data/non_m_theory_ijk/theory_data/simu_data_m.xlsx', index_col = 0, sheet_name = None)
    print('m-simu data imported')
    return _data
    
def import_simu_data_nm():
    _data = pd.read_excel('../Experimental_Data/non_m_theory_ijk/theory_data/simu_data_nm.xlsx', index_col = 0, sheet_name = None)
    print('nm-simu data imported')
    return _data
    
def import_steady_simu_data():
    _data = pd.read_excel('../Experimental_Data/non_m_theory_ijk/theory_data/steady_simu_data.xlsx', index_col = 0, sheet_name = None)
    print('steady-simu data imported')
    return _data
    
def import_steady_calc_data():
    _data = pd.read_excel('../Experimental_Data/non_m_theory_ijk/theory_data/steady_calc_data.xlsx', index_col = 0, sheet_name = None)
    print('steady-calc data imported')
    return _data

def import_steady_simu_mar_data():
    _data = pd.read_excel('../Experimental_Data/non_m_theory_ijk/theory_data/steady_simu_mar_data.xlsx', index_col = 0, sheet_name = None)
    print('steady-simu-mar data imported')
    return _data
    
def import_steady_calc_mar_data():
    _data = pd.read_excel('../Experimental_Data/non_m_theory_ijk/theory_data/steady_calc_mar_data.xlsx', index_col = 0, sheet_name = None)
...
def import_explain_data():
    explain_data = {}
    for i in range(100):
        explain_data['data_curves_' + str(i)] = pd.read_excel('../Experimental_Data/explain/explain_datax/data_curves_'+ str(i) + '.xlsx', index_col = 0, sheet_name = None)
...
def import_forecasting_curve_data():
    ...
    for file_mark in ['-6_24', '9_9', '24_-6']:
        forecasting_curve_data[file_mark] = pd.read_excel('../Experimental_Data/simu_fitting_i5r7/fitting_data/data_curves_'+ file_mark + '.xlsx', index_col = 0, sheet_name = None)
    print('forecasting-curve data imported')
    return forecasting_curve_data
 
def import_forecasting_data():   
    folder_name = {'weibull_i5r7': 'simu_fitting_i5r7/fitting_data', 'weibull_i5r5': 'simu_fitting_i5r5/fitting_data', 'weibull_i7r7': 'simu_fitting_i7r7/fitting_data', 
                   'lognormal_i5r7': 'simu_fitting_lognormal_i5r7/lognormal_fitting_data', 'gamma_i5r7': 'simu_fitting_gamma_i5r7_n/gamma_fitting_data'}
    forecasting_data = {}
    for func_type, mean_inf, mean_rem, steady_level in trans_list[:5]:
        ...
        for inf_pow in param_range[func_type]:
            for rem_pow in param_range[func_type]:
                ...
                pd.read_excel('../Experimental_Data/' + folder_name[func_type + '_i' + str(mean_inf) + 'r' +  str(mean_rem)] + 
...
def import_real_forecasting_data():
    ...
    for disease in ['covid_19', 'sars', 'h1n1', 'smallpox']:
        real_forecasting_data[disease] = pd.read_excel('../Experimental_Data/real_fitting/real_fitting_data/data_' + disease + '.xlsx', index_col = 0, sheet_name = None)
...
def import_vac_curve_data():
    ...
    for file_mark in ['9_9']:
        vac_curve_data[file_mark] = pd.read_excel('../Experimental_Data/simu_vac_fitting_i5r7/fitting_vac_data/data_vac_curves_'+ file_mark + '.xlsx', index_col = 0, sheet_name = None)
...
def import_vac_data():
    folder_name = {'weibull_i5r7': 'simu_vac_fitting_i5r7/fitting_vac_data', 'weibull_i5r5': 'simu_vac_fitting_i5r5/fitting_vac_data', 
                   ...
                   'lognormal_i5r7': 'simu_vac_fitting_lognormal_i5r7/fitting_vac_data', 'gamma_i5r7': 'simu_vac_fitting_gamma_i5r7/fitting_vac_data'}
    vac_data = {}
    for func_type, mean_inf, mean_rem, steady_level in trans_list[:5]:
...
def import_real_vac_data():         
    real_vac_data = {}
    for disease in ['covid_19', 'sars', 'h1n1', 'smallpox']:
        real_vac_data[disease] = pd.read_excel('../Experimental_Data/real_vac_fitting/real_vac_fitting_data/data_' + disease + '.xlsx', index_col = 0, sheet_name = None)
