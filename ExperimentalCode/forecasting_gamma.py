...
if __name__ == '__main__':
    ...
    for pair_item in group_param_list[rank]:
        ...
        if add_mark:
            writer_add = pd.ExcelWriter("../ExperimentalData/forecasting_data_gamma/data_curves_"+ file_mark + ".xlsx")
        writer = pd.ExcelWriter("../ExperimentalData/forecasting_data_gamma/data_"+ file_mark + ".xlsx")
