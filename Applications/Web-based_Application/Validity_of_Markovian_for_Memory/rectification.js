...
function plot_params() {
    ...
    Plotly.newPlot('contact', [trace], layout);
    ...
    for (let i = 1; i < 3; i++){
        ...
        Plotly.newPlot(bar_names[i - 1], [trace], layout);
    }
}
...
function plot_r0(){
    ...
    Plotly.newPlot('r_0_rectified', [trace], layout);
}
...
function plot_c(){
    ...
    let layout = {
        ...
        xaxis: { title: { text: 'Age Group Index', font: { size: div_width * 0.05 } }},
        yaxis: { title: { text: 'Fraction', font: { size: div_width * 0.05 } } },
        legend: { font: { size: div_width * 0.027 }, x: 0.7, y: 1, orientation: 'v', bgcolor: 'rgba(0, 0, 0, 0)'},
        margin: { t: div_width * 0.1, b: div_width * 0.1, l: div_width * 0.2, r: div_width * 0.2 },
        width: div_width,
        height: div_width * 0.6
    };
    Plotly.newPlot('c_rectified', data, layout);
    div_width = window.innerHeight * 0.4
    ...
    layout = {
        ...
        width: div_width,
        height: div_width * 0.6};
    Plotly.newPlot('c_tot_rectified', [trace], layout);
