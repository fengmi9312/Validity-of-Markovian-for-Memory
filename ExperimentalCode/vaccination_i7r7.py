...
for inf_pow, rem_pow in group_param_list[rank]:
    ...
    steady_data = {}
    writer = pd.ExcelWriter("../ExperimentalData/vaccination_data_i7r7/data_vac_"+ file_mark + ".xlsx")
    if add_mark:
        writer_add = pd.ExcelWriter("../ExperimentalData/vaccination_data_i7r7/data_vac_curves_"+ file_mark + ".xlsx")
