...
if rank >= 3:
    sys.exit()
'''
# If you are running the code on Windows, you can utilize the following two line of code.
sys.path.append('../Dependencies/ModuleDependencies(Windowns)')
rank = 0 # The rank should be limited to the range(3)
...
alpha_inf, beta_inf, alpha_rem, beta_rem = 3, 1, 2.5, 0.9
...
if rank == 0:
    writer_simu = pd.ExcelWriter("../ExperimentalData/theory_compare_data/simu_data.xlsx")
    writer_calc = pd.ExcelWriter("../ExperimentalData/theory_compare_data/calc_data.xlsx")
    simu_curve_data = []
    max_spread_len = 0
    ...
    simu_curve_data_n = []
    writer_simu_m = pd.ExcelWriter("../ExperimentalData/theory_compare_data/simu_data_m.xlsx")
    writer_simu_nm = pd.ExcelWriter("../ExperimentalData/theory_compare_data/simu_data_nm.xlsx")
    for alpha_inf_n, alpha_rem_n, beta_rem_n in ((1, 1, 1.8), (1.5, 2, 0.6)):
    ...
    steady_point_len = 40
    writer_steady_simu = pd.ExcelWriter("../ExperimentalData/theory_compare_data/steady_simu_data.xlsx")
    writer_steady_calc = pd.ExcelWriter("../ExperimentalData/theory_compare_data/steady_calc_data.xlsx")
