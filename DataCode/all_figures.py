...
if not using_imported_data:
    ...
    figure_theories_data = generate_data.generate_figure_theories_data(simu_data, calc_data, simu_data_m, simu_data_nm, 
                                                                       steady_simu_data, steady_calc_data, steady_simu_mar_data, 
                                                                       steady_calc_mar_data, transient_data)
    ...
    figure_forecasting_data, fitting_period_data= generate_data.generate_figure_forecasting_data(forecasting_curve_data, forecasting_data, real_forecasting_data, 
                                                                                                 log_ratios)
